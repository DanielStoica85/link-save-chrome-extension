...
<<<<<<< HEAD
  ...
  savedLinks.forEach(element => {
    ...
    var listElement =
      ...
      element.url +
      '" class="added-link">' +
      '<div class="row"><h4 class="list-group-item-heading">' +
      element.title +
      '</h4></a><button class="btn btn-xs qr-code"><span class="glyphicon glyphicon-qrcode"></span></button><a href="edit.html?index=' +
      element.index +
      '" class="btn btn-xs edit-url"><span class="glyphicon glyphicon-edit"></span></a></div>' +
      '<div class="row"><p class="list-group-item-text"><a href="' +
      element.url +
      '" class="added-link">' +
      element.url.substring(0, 20) +
      "..." +
      '</a></p><button class="btn btn-xs delete-url"><span class="glyphicon glyphicon-remove"></span></button></div></li>';
